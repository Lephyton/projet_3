...
class Level:
    ...
    def __init__(self):
        ...
        self.macg = pygame.image.load(IMG_SATRT).convert()
...
class Order:
    ...
    def game_over(self, data, pos_col, pos_ligne):
        ...
        if data[pos_col][pos_ligne] == "O":
            if self.num_ob == 3:
                print(
                    "Bravoooo !!!! vous avez gagné et vous avez : "
                    + str(self.num_ob)
                    + " objets"
                )
                return True
                ...
                print(
                    "Désolé !!!! vous avez perdu et vous avez seulement : "
                    + str(self.num_ob)
                    + " objets"
                )
                return True
